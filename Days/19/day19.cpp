...
int main(int argc, const char * argv[]) {
	...
	int r0 = 0, r2 = 1, r4 = 10551378, r5 = 1;
/** /
	for (auto r5 = 1; r5 <= r4; r5++)
	{
		for (auto r2 = 1; r2 <= r4; r2++)
		{
			if (r5 * r2 == r4)//r4 % r2 ==0
			{
				r0 += r5;
	...
	vector<unsigned long long> registers = { 1, 0, 0, 0, 0, 0 };
	vector<unsigned long long> oldRegisters = { 1, 0, 0, 0, 0, 0 };
	int oldIp = 0;

	ofstream fout("c:\\aoc\\out19_3.txt");
